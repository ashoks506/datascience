...
#create an instance of RandomizedSearch class
...
print(random_dt_estimator.score(X_train, y_train))

#get the detailed train and cv scores across grid
print(random_dt_estimator.cv_results_.get('mean_test_score'))
print(random_dt_estimator.cv_results_.get('mean_train_score'))
